locals {
  ...
  app_configs = [module.app_config, module.app-catala_config, module.app-docai_config, module.app-flask_config, module.app-nextjs_config, module.app-rails_config]
...
module "app-docai_config" {
  source = "../app-docai/app-config"
}
