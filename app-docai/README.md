...
![Architecture Diagram](../docs/app-docai/media/architecture.png)
...
- `API_AUTH_INSECURE_SHARED_KEY` - API authentication key (see [API Authentication](../docs/app-docai/api-authentication.md))
...
API endpoints require an `API-Key` header. See [API Authentication](../docs/app-docai/api-authentication.md) for details. 
...
For more details on API endpoints, see [openapi.json](../app-docai/docs/openapi.json).
...
For more details on writing tests, see [Writing Tests](../docs/app-docai/writing-tests.md).
