...
![Architecture Diagram](../docs/app-documentai-api/media/architecture.png)
...
- `API_AUTH_INSECURE_SHARED_KEY` - API authentication key (see [API Authentication](../docs/app-documentai-api/api-authentication.md))
...
API endpoints require an `API-Key` header. See [API Authentication](../docs/app-documentai-api/api-authentication.md) for details. 
...
For more details on API endpoints, see [openapi.json](../app-documentai-api/docs/openapi.json).
...
For more details on writing tests, see [Writing Tests](../docs/app-documentai-api/writing-tests.md).
