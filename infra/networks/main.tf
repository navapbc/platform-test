locals {
  ...
  app_configs = [module.app_config, module.app-catala_config, module.app-documentai-api_config, module.app-flask_config, module.app-nextjs_config, module.app-rails_config]
...
module "app-catala_config" {
  source = "../app-catala/app-config"
}

module "app-documentai-api_config" {
  source = "../app-documentai-api/app-config"
}

module "app-flask_config" {
  source = "../app-flask/app-config"
}

module "app-nextjs_config" {
  source = "../app-nextjs/app-config"
}
